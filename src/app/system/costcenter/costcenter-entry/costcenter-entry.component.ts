...
import { CostCenterEntryService } from './costcenter-entry.service';
import { Direction } from '@angular/cdk/bidi';

@Component({
  selector: 'app-costcenter-entry',
  templateUrl: './costcenter-entry.component.html',
  styleUrls: ['./costcenter-entry.component.scss']
})
...
export class CostCenterEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: CostCenterEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<CostCenterEntryComponent>,
