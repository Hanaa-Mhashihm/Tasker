...
import { ProcExpenseEntryService } from './procexpense-entry.service';
import { Direction } from '@angular/cdk/bidi';

@Component({
  selector: 'app-procexpense-entry',
  templateUrl: './procexpense-entry.component.html',
  styleUrls: ['./procexpense-entry.component.scss']
})

export class ProcExpenseEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: ProcExpenseEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<ProcExpenseEntryComponent>,
