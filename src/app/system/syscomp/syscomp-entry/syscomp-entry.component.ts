...
import { SysCompEntryService } from './syscomp-entry.service';
import { Direction } from '@angular/cdk/bidi';

@Component({
  selector: 'app-syscomp-entry',
  templateUrl: './syscomp-entry.component.html',
  styleUrls: ['./syscomp-entry.component.scss']
})

export class SysCompEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: SysCompEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<SysCompEntryComponent>,
