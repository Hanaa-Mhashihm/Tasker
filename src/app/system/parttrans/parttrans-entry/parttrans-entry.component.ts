...
import { PartTransEntryService } from './parttrans-entry.service';
import { Direction } from '@angular/cdk/bidi';

@Component({
  selector: 'app-parttrans-entry',
  templateUrl: './parttrans-entry.component.html',
  styleUrls: ['./parttrans-entry.component.scss']
})

export class PartTransEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: PartTransEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<PartTransEntryComponent>,
          ...
          if(this.data.length > 0) {
            ...
            this._ui.loadingStateChanged.next(false);
              ...
              for(let k=0;k<res.length;k++){
                this.addChild1Item(res[k].partTransDetId)
