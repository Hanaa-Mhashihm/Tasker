...
export class AccountOpenComponent implements OnInit {
  ...
  ngOnInit() {
    this.titleService.setTitle("Account opening balance - Tasker");
      this.refreshMe();
  }
  ...
  refreshMe() {
    if(localStorage.getItem(this._globals.baseAppName + '_language') == "16001") {
      this.direction = "ltr"
      this.header = "Account opening balance"
      ...
      this.direction = "rtl"
      this.header = "الرصيد الافتتاحي للحساب"
      this.accountOpenId = "accountOpenId"
      this.edit = "تعديل"
      this.submit = "ارسال"
      this.cancel = "الغاء"
  ...
  onAdd  () {
    ...
    if(localStorage.getItem(this._globals.baseAppName + '_language') == "16001") {
      localStorage.setItem(this._globals.baseAppName + '_Add&Edit', "Add account opening balance");
    }else if(localStorage.getItem(this._globals.baseAppName + '_language') == "16002") {
      localStorage.setItem(this._globals.baseAppName + '_Add&Edit', "اضافة رصيد فتح الحساب");
    }
  ...
  onEdit = (id: number) => {
    ...
    if(localStorage.getItem(this._globals.baseAppName + '_language') == "16001") {
      localStorage.setItem(this._globals.baseAppName + '_Add&Edit', "Edit account opening balance");
    }else if(localStorage.getItem(this._globals.baseAppName + '_language') == "16002") {
      localStorage.setItem(this._globals.baseAppName + '_Add&Edit', "تعديل رصيد فتح الحساب ");
    }
  ...
  openEntry  (result: AccountOpenModel) {
    if (result === undefined) {
