...
import { CustOpenEntryService } from './custopen-entry.service';
import { Direction } from '@angular/cdk/bidi';

@Component({
  selector: 'app-custopen-entry',
  templateUrl: './custopen-entry.component.html',
  styleUrls: ['./custopen-entry.component.scss']
})

export class CustOpenEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: CustOpenEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<CustOpenEntryComponent>,
