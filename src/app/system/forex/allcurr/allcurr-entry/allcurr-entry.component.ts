...
import { AllCurrEntryService } from './allcurr-entry.service';
import { Direction } from '@angular/cdk/bidi';

@Component({
  selector: 'app-allcurr-entry',
  templateUrl: './allcurr-entry.component.html',
  styleUrls: ['./allcurr-entry.component.scss']
})

export class AllCurrEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: AllCurrEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<AllCurrEntryComponent>,
