...
import { ShareholderEntryService } from './shareholder-entry.service';
import { Direction } from '@angular/cdk/bidi';

@Component({
  selector: 'app-shareholder-entry',
  templateUrl: './shareholder-entry.component.html',
  styleUrls: ['./shareholder-entry.component.scss']
})
...
export class ShareholderEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: ShareholderEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<ShareholderEntryComponent>,
