...
import { FiscalYearEntryService } from './fiscalyear-entry.service';
import { Direction } from '@angular/cdk/bidi';

@Component({
  selector: 'app-fiscalyear-entry',
  templateUrl: './fiscalyear-entry.component.html',
  styleUrls: ['./fiscalyear-entry.component.scss']
})

export class FiscalYearEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: FiscalYearEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<FiscalYearEntryComponent>,
