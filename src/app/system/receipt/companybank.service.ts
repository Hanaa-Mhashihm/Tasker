...
export class CompanyBankService {
   ...
   getCompanyBankEntry(id: number): Observable<any> {
      return this.httpClient.get<any>(this._globals.baseAPIUrl + 'receipt/' + id).pipe(
      map((result: any) => {
      return result;
   ...
   getCompanyBankSubmit(data: any) {
      ...
      switch (data.entryMode) {
          ...
          case 'A': {
          return this.http.post(this._globals.baseAPIUrl + 'receipt/create', data, this._cf.requestOptions()).pipe(
          ...
          case 'E': {
          return this.http.post(this._globals.baseAPIUrl + 'receipt/edit', data, this._cf.requestOptions()).pipe(
          map((response: Response) => {
          return response.json();
          }), catchError(this._cf.handleError));
          }
          ...
          case 'D': {
          return this.http.post(this._globals.baseAPIUrl + 'receipt/delete', data, this._cf.requestOptions()).pipe(
          map((response: Response) => {
          return response.json();
          }), catchError(this._cf.handleError));
          }
