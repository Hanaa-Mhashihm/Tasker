...
export class CompanyBankEntryService {
    ...
    constructor(private _globals: AppGlobals,
        ...
        companyBankControllers(model: Send) {
            return this.http.post(this._globals.baseAPIUrl + 'receipt/getuniventry', model, this._cf.requestOptions()).pipe(
           map((response: any) => {
           ...
           return this.http.post(this._globals.baseAPIUrl + 'receipt/createuniv',arr);
        }

        companyBankEntryE(arr: any){
           return this.http.post(this._globals.baseAPIUrl + 'receipt/edituniv',arr);
        }
