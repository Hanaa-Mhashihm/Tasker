...
import { SuppOpenEntryService } from './suppopen-entry.service';
import { Direction } from '@angular/cdk/bidi';

@Component({
  selector: 'app-suppopen-entry',
  templateUrl: './suppopen-entry.component.html',
  styleUrls: ['./suppopen-entry.component.scss']
})

export class SuppOpenEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: SuppOpenEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<SuppOpenEntryComponent>,
