...
import { ContWareEntryEntryService } from './contwareentry-entry.service';
import { Direction } from '@angular/cdk/bidi';

@Component({
  selector: 'app-contwareentry-entry',
  templateUrl: './contwareentry-entry.component.html',
  styleUrls: ['./contwareentry-entry.component.scss']
})

export class ContWareEntryEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: ContWareEntryEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<ContWareEntryEntryComponent>,
  ...
  ngOnInit() {
    if(localStorage.getItem(this._globals.baseAppName + '_language') == "16001") {
      ...
      this.dapiService.Controllers(this.pModel.array).subscribe(res => {
        ...
        this.data = res;
        this.data[1].value= (this.pModel.BookContProdId).toString()
