...
export class AccountComponent implements OnInit {
  ...
  indexes!: any[];
    ...
    displayedColumns: string[] =
        ['select', 'type', 'AccountCode', 'AccountName', 'AccountType'];
  ...
  ngOnInit() {
    this.titleService.setTitle("Account - Tasker");
      this.refreshMe();
  }
  ...
  refreshMe() {
    if(localStorage.getItem(this._globals.baseAppName + '_language') == "16001") {
      this.direction = "ltr"
      this.header = "Account"
      this.accountCode = "Account Iris"
      this.accountName = "Acct Description"
      this.accountType = "Source"
      this.type =  "Type"
      ...
      this.accountName = "وصف الحساب"
      this.accountType = "المصدر"
      this.balance = "الحساب"
      this.edit = "تعديل"
      this.submit = "ارسال"
      this.cancel = "الغاء"
