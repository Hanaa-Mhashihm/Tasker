...
import { ProdTransProdEntryService } from './prodtransprod-entry.service';
import { Direction } from '@angular/cdk/bidi';

@Component({
  selector: 'app-prodtransprod-entry',
  templateUrl: './prodtransprod-entry.component.html',
  styleUrls: ['./prodtransprod-entry.component.scss']
})

export class ProdTransProdEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: ProdTransProdEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<ProdTransProdEntryComponent>,
