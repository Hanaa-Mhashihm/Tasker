...
import { SuppInvPartEntryService } from './suppinvpart-entry.service';
import { Direction } from '@angular/cdk/bidi';

@Component({
  selector: 'app-suppinvpart-entry',
  templateUrl: './suppinvpart-entry.component.html',
  styleUrls: ['./suppinvpart-entry.component.scss']
})

export class SuppInvPartEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: SuppInvPartEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<SuppInvPartEntryComponent>,
