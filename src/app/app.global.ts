...
export class AppGlobals {
  ...
  /* Development Server */
  readonly baseAPIFileUrl: string = "http://taskerapi.autopay-mcs.com/";
  readonly baseAPIUrl: string = "http://taskerapi.autopay-mcs.com/api/";
  readonly baseAPIRootUrl: string = "http://taskerapi.autopay-mcs.com/api/";
  ...
  readonly baseReportUrl: string = 'http://greenfieldreports.autopay-mcs.com/default.aspx?';
